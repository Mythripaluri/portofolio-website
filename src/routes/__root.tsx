  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Portfolio of Mythri Prasanna. Building scalable web, mobile, and AI-powered applications with React Native, FastAPI, Node.js and modern LLM tooling.",
      },
      { name: "author", content: "Mythri Prasanna" },
      {
        property: "og:title",
        content: "Mythri Prasanna — Full Stack, Mobile & AI Developer",
      },
      {
